...
<head>
    ...
    <title>Bukti Setoran Tabungan Siswa</title>
</head>
<style>
    .container {
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="column" style="float: left">
                Jenis Surat : Bukti Setoran Tabungan Siswa<br>
        ...
        <div class="detail">
            <table>
                ...
                <tbody>
                    <tr>
                        <td>{{ $buktiSetoran->tabungan->user->siswa->nm_siswa }}</td>
                        <td>Rp. {{ number_format($buktiSetoran->nominal, 2) }}</td>
                        <td>{{ $buktiSetoran->status }}</td>
                        <td>{{ $buktiSetoran->created_at }}</td>
                    </tr>
